...
import logging
logger = logging.getLogger('fotopull_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by FotopullWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseFotopullWindow object.
        """
        builder = get_builder('FotopullWindow')
        new_object = builder.get_object("fotopull_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a FotopullWindow object with it in order to finish
        initializing the start of the new FotopullWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.fotopull")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('fotopull')
        except ImportError:
            pass
        ...
        try:
            from fotopull import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for fotopull."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for fotopull."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the FotopullWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the FotopullWindow is closed."""
